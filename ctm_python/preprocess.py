...
'''
This file is used to seperate the pre-procesing part of ctm.
Mainly adpots gensim's processing file, but without the stemmer.
And to make adjusting STOPWORDS list easier, or get rid of it.
'''
...
def get_dict_and_corp(raw_corpus):
